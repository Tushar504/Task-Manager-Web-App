...
export const Taskpage=()=>{
  ...
  const handleChange = (event) => {
    dispatch(TaskPageData(token,id,event.target.value))
    ...
    return (<div className="PagesOuterSideDiv">
      ...
      <Chip sx={{backgroundColor:'rgb(25,118,210)', color:"white", margin:1.5,fontWeight:'bold'}} label={`${id.toUpperCase()}-TASKS`} variant="outlined" />
